...
def main(input, output, robot_ip, match_dataset, match_episode,
    ...
    use_pigdm = False
    if use_pigdm == True:
        cfg._target_ = 'diffusion_policy.workspace.bae_train_diffusion_unet_hybrid_pigdm_workspace.TrainDiffusionUnetHybridPigdmWorkspace' # cfg._target_으로 Workspace 생성
        cfg.policy._target_ = "diffusion_policy.policy.bae_diffusion_unet_hybrid_image_policy_pigdm.DiffusionUnetHybridImagePigdmPolicy" # Workspace가 cfg.policy._target_으로 Policy 생성
        cfg.policy.noise_scheduler._target_ = "bae_scheduling_ddim_pigdm.DDIMPIGDMScheduler" # Policy 생성 시 내부 구성요소로 cfg.policy.noise_scheduler._target_ 스케줄러 생성
