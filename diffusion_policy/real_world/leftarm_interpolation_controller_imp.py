...
class LeftarmImp(Node):
    def __init__(self):
        super().__init__('leftarm_imp_node')
...
class LeftarmInterpolationControllerImp(mp.Process):
    """
    ...
    def __init__(self,
        ...
        print("[DEBUG] Robot Controller initialized (Impedance Mode)")
    ...
    def run(self):
        ...
        print("[DEBUG] Robot Running (Impedance Mode)")
        # start rtde
        ...
        try:
            ...
            while latest_joint_L is None or None in latest_joint_L:
