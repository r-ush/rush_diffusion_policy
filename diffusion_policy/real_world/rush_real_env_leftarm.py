...
from diffusion_policy.real_world.leftarm_interpolation_controller import LeftarmInterpolationController
...
class LeftarmRealEnv:
    def __init__(self, 
        ...
        # 로봇
        robot = LeftarmInterpolationController(
            shm_manager=shm_manager,
            robot_ip=robot_ip,
            frequency=125, 
            lookahead_time=0.1,
    ...
    def exec_actions(self, 
        ...
        q_size = self.robot.input_queue.qsize()
        if q_size > 128:
            print(f"[WARN] exec_actions: input_queue size={q_size} (>128), clearing stale waypoints.")
            self.robot.input_queue.clear()
