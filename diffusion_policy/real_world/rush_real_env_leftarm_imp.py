...
from diffusion_policy.real_world.leftarm_interpolation_controller_imp import LeftarmInterpolationControllerImp
...
class LeftarmRealEnvImp:
    def __init__(self, 
        ...
        # 로봇
        robot = LeftarmInterpolationControllerImp(
            shm_manager=shm_manager,
            robot_ip=robot_ip,
            frequency=125, 
            lookahead_time=0.1,
